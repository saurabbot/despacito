  ...
  return (
    <main className="flex dark:bg-white dark:text-black  flex-col items-center">
      ...
      <div className="flex w-full">
        <div className="w-1/2 m-2 flex flex-col justify-between bg-black text-white font-bold text-5xl p-3 rounded-xl">
          ...
          <Carousel variant="default" childrenLength={6}>
            ...
            <div className=" p-2 rounded-lg bg-white text-black text-base ">
              We make sure that your transfer from the current organisation to
              the next one is an extremely hastle-free process
            </div>
            <div className=" p-2 rounded-lg bg-white text-black text-base ">
              You can get hired for the company in the remotest of places on
              this earth
            </div>
            <div className=" p-2 rounded-lg bg-white text-black text-base ">
              We are we pecuiliar about the candidate and his culture fitnes in
